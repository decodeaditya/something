      ...
      <AnimatePresence mode="wait">
        ...
        {route.page === 'about' && (
          <motion.div key="about" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pt-40 pb-20 px-8 max-w-5xl mx-auto text-center">
            ...
            <p className="text-4xl normal-case italic text-zinc-300 leading-tight mb-16">
            ...
            <p className="text-2xl normal-case italic text-zinc-500 mb-20">
              Silence is betrayal. Action is loyalty to the Republic.
            </p>
            <button onClick={() => navigate('')} className="bg-white text-black px-16 py-8 text-3xl italic hover:bg-orange-600 transition-all">
              RETURN_TO_THE_FIGHT
            </button>
          </motion.div>
        )}
